...
def can_see_group_members(user_id: int, group: DBGroup, db: Session) -> bool:
    if group.is_public:
        ...
        can_see_members = True if req_user_membership else False

    return can_see_members
...
def can_delete_post(user_id: int, post_id: int) -> bool:
    pass
